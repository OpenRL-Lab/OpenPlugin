...
def get_version() -> str:
    ...
    init = open(os.path.join("openplugin", "__init__.py"), "r").read().split()
...
setup(
    ...
    url="https://github.com/OpenRL-Lab/openplugin",
    packages=setuptools.find_packages(),
    entry_points={"console_scripts": ["op=openplugin.cli.cli:cli"]},
    project_urls={
